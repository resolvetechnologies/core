...
/**
 * @title Resolve governance token
 * @dev Resolve's native token that represents ownership shares of Resolve.
...
contract Lysi is ERC20, ERC20Burnable, ERC20Permit, ERC20Votes {
    constructor(address developmentFund) ERC20("Remedy", "Lysi") ERC20Permit("Remedy") {
        // Mint entire supply to Resolve Development Fund for liquidity bootstrapping.
